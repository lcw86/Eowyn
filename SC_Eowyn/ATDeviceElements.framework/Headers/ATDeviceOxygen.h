...
- (BOOL) uartTransferWithReadTerminator: (NSString*_Nullable) readTerminator
                            andWriteLen: (uint8_t)   writeLen
                          andActualRead: (uint16_t*_Nullable) actualRead
                                andData: (nonnull uint8_t*)  data
                     andUartReadTimeOut: (uint16_t)  uartReadTimeOutInMiliSeconds
                               andError: (NSError *_Nullable*_Nullable) aError;
...
*
* param[in] maxBytesToFlush:                Maximum nuymber of bytes to flush, this is an upper limit
* param[in] uartTimeOutInMiliSeconds:       This is a lower limit on the length of time this call will take.  This should be as small as possible
*                                           Increase this if you are not getting the UART buffer flushed appropriately
